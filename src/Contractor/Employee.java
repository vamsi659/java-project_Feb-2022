...
//		}
	...
	// 2. const will be called when u create the object but function will be called
	// using obj ref variable
	// 3. const will help to create the object with class variable, it should not
	// have any buss logic
	// but function u should write business logic
	...
	public static void main(String a[]) {
		...
		Employee e3 = new Employee("ram", 25);

		Company c1 = new Company("IBM", "Pune");
		System.out.println(c1.name + " " + c1.hq);
		Company c2 = new Company("TCS", "Bangalore", 5, true, 30.99);
		System.out.println(c2.name + " " + c2.hq +" "+ c2.empCount + " "+ c2.isActive + " " +
c2.sharePrice);
	}
